    ...
    public class Model : IModel
    {
        ...
        private void StartedStageHandler()
        {
            ...
            foreach (var runway in runways.Values)
            {
                ...
                var nominalEngineStartMoments = takingOffBundle.GetNominalEngineStartMoments(takingOffBundle);
        ...
        private void AddBundlesToChart(IRunway runway, AircraftType type, 
            ChartMomentDataType subType = ChartMomentDataType.Default)
        {
            var bundles = type == AircraftType.Landing ? runway.LandingBundles : runway.TakingOffBundles;
        ...
        {
            AddBundlesToChart(runway, AircraftType.Landing);
            AddBundlesToChart(runway, AircraftType.TakingOff);
            AddBundlesToChart(runway, AircraftType.TakingOff, ChartMomentDataType.Outdated);
        }
        ...
        // коммент для отработки merge conflict
