...
namespace OptimalMotion2.Domain
{
    public class AircraftGenerator : IAircraftGenerator
    {
        ...
        public ILandingAircraft GetLandingAircraft(ILandingAircraftMoments moments,
            ILandingAircraftIntervals intervals, int runwayIndex = 0)
        {
        ...
        private ITakingOffAircraftIntervals GetTakingOffAircraftCreationIntervals()
        {
        ...
        private ILandingAircraftData GetLandingAircraftCreationData(ILandingAircraftMoments moments, 
            ILandingAircraftIntervals intervals, int runwayIndex = 0)
        {
            var id = idGenerator.GetUniqueAircraftId();

            return new LandingAircraftData(id, moments, intervals, runwayIndex);
        }
    }
}
